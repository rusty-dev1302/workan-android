...
import 'hammerjs';
import { DashboardProfessionalPaymentsComponent } from './components/dashboard-professional-payments/dashboard-professional-payments.component';
...
const routes: Routes = [
  ...
  { path: 'listingDetail/:id', component: ListingDetailsComponent, canActivate: [AuthGuard] },
  {
    path: 'dashboard', component: DashboardComponent, canActivate: [AuthGuard],
          ...
          { path: 'professionalpayments', component: DashboardProfessionalPaymentsComponent, canActivate: [ProfessionalGuard] },
...
@NgModule({
  declarations: [
    ...
    DashboardProfessionalPaymentsComponent,
  ],
  imports: [
